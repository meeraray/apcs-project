...
public class Textures { 
	...
	private static String[] playerPNames = { "steve/steve_P_0.png","steve/steve_P_1.png","steve/steve_P_2.png","steve/steve_P_3.png","steve/steve_P_4.png" };
	public static Texture[] playerPFrames;
	...
	public static Texture winScreen, loseScreen, outOfTimeScreen;
	...
	public static void init() {
		try {			
			...
			playerPFrames = Spritesheet.spliceLoad(playerPNames, "PNG");
			...
			flame = Spritesheet.spliceLoad(flameNames, "PNG");
			...
			outOfTimeScreen = load("scenebackgrounds/outoftime_screen.png", "PNG");
